...
$features = [
    [
        'title' => esc_html__("Multiple notification bars", "mystickymenu"),
        'tooltip' => esc_html__("Create a separate notification bar for different pages based on page targeting rules (E.g. for different languages, different product categories and much more)", "mystickymenu"),
    ],
    [
        'title' => esc_html__("Countdown timer", "mystickymenu"),
        'tooltip' => esc_html__("Add a countdown timer element to your notification bars to increase conversion rate, announce flash sales, and more", "mystickymenu") . '<img src="'.MYSTICKYMENU_URL .'/images/countdown.gif" />'
    ],
	[
        'title' => esc_html__("Sliding Texts or carousels", "mystickymenu"),
        'tooltip' => esc_html__("Enhance Your Sticky Menu with Sliding Text. Display multiple lines of content that can scroll automatically in your desired direction.", "mystickymenu") . '<img src="'.MYSTICKYMENU_URL .'/images/sliding-text.gif" />'
    ],
    [
        'title' => esc_html__("Send contact form leads to email", "mystickymenu"),
        'tooltip' => esc_html__("Send contact form leads to your email of choice", "mystickymenu") .'<img src="'.MYSTICKYMENU_URL.'/images/contact-lead-ss-1.png" />'
    ],
    [
    ...
    [
        ...
        'tooltip' => esc_html__("Add CSS of your own to the sticky menu", "mystickymenu")
    ],
    [
    ...
    [
        ...
        'tooltip' => esc_html__("Including page targeting, delay and scroll triggers, devices, position, height, expiry date, open link in a new tab", "mystickymenu")
    ],    
];
?>
            ...
            <div class="plan-details-bottom">
                <div class="plan-options">
                    <div class="plan-option active" data-id="1_year">
                        <div class="plan-title"><?php esc_html_e("1 year", "mystickymenu"); ?></div>
                        <div class="plan-desc"><?php esc_html_e("Updates & Support", "mystickymenu"); ?></div>
                    </div>
                    <div class="plan-option" data-id="2_years">
                        <div class="plan-title"><?php esc_html_e("2 years ", "mystickymenu"); ?><span>(32% Off
                    ...
                    <div class="plan-option" data-id="lifetime">
                        <div class="plan-title"><?php esc_html_e("Lifetime ", "mystickymenu"); ?><span>(60% Off
                            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <rect y="0.712891" width="17" height="17" fill="url(#pattern0)"/>
                            <defs>
                            <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                    ...
                    <div class="pricing-header-top">
                        <div class="plan-row">
                            <div class="plan-col first-col plan-data">
                                <span class="plan-plugin-name">My Sticky Bar</span>
            ...
            <div class="testimonial-list">
                ...
                $reviews = [
                    [
                        ...
                        'image'     => plugins_url('/images/gigena.jpeg', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/gigena/',
                        'comment'   => "everything works great <br/>Very useful when you want to save writing CSS code for this."
                    ],
                    [
                        'name'      => 'Pastor Abraham David',
                        'position'  => 'Lead Pastor of Christ’s Habitation Ministries.',
                        'image'     => plugins_url('/images/pastorabrahamdavid.jpeg', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/pastorabrahamdavid/',
                        'comment'   => 'Amazing plugin<br />This plugin does exactly what I want. I’m happy I found it.'
                    ],
                    [
                        'name'      => 'Dena Norton',
                        'position'  => 'Owner of Back to the book nutrition',
                        'image'     => plugins_url('/images/Back To The Book Nutrition.png', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/back-to-the-book-nutrition/',
                        'comment'   => 'GREAT free plugin!<br />This was a great option to advertise my sale. Impressed with the customization available even on the free version – it looked great, performed well, and played nice with my other header elements. Definitely recommend!'
                    ],
                    [
                        'name'      => 'Borja Girón',
                        'position'  => 'Entrepreneur, borjagiron.com',
                        'image'     => plugins_url('/images/Borja.jpeg', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/borjagironhotmailcom/',
                        'comment'   => 'The best at the best price <br/>I have reviewed several countdown bars and this is the best with a reduced price of €25 per year. It helps me a lot to get more sales.'
                    ],
                    [
                        'name'      => 'Mark Cerisano',
                        'position'  => 'Owner of How to Tune Pianos',
                        'image'     => plugins_url('/images/mcerisano.jpeg', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/mcerisano/',
                        'comment'   => 'Love it!<br />Does exactly what I want and has an intuitive user interface.'
                    ],
                    [
                        'name'      => 'Sara Dagan',
						'position'  => 'Owner of vgfoodstory.com',
                        'image'     => plugins_url('/images/sarad100.png', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/sarad100/',
                        'comment'   => 'Great Plugin – Great Service<br />
This plugin works! Although I’m a newbie to WordPress I managed to make my top menu bar sticky.<br/>
The service is professional and helpful – you are taken step by step until the plugin is installed and works.'
                    ],
                    [
                        'name'      => 'Henk-Jan Bezemer',
						'position'  => 'GP at hjbezemer-huisarts.nl',
                        'image'     => plugins_url('/images/Henk.Jan.jpeg', __FILE__),
                        'profile'   => 'https://wordpress.org/support/users/henkjan-1/',
                        'comment'   => "Great plugin with excellent support. I had some issues caused by another plugin. They helped me the whole way true to get a solution. Now it works again just like I like and want it. Awesome!"
                    ],                    
                ];
                        ...
                        <div class="client-testimonial-slide">
                            <a href="<?php echo esc_url($review['profile']) ?>" target="_blank">
                                ...
                                <div class="client-text">
                                    <?php echo wp_kses($review['comment'], $allowedTags); ?>
                                </div>
...
<div class="premio-faqs">
    <div class="price-container">
        <div class="faq-title"><?php esc_html_e("Frequently Asked Questions", "mystickymenu") ?></div>
        <div class="faq-lists">
            <?php
            $faqs = [
                [
