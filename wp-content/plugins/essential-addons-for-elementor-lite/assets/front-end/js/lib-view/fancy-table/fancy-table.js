 ...
 *
 * This is customized from main code.
 * Some slector changes ex: pagination, search location
 */
(function ($) {
    $.fn.fancyTable = function (options) {
        var settings = $.extend({
            ...
            pagination: false,
            paginationClass: "eael-ec-pagination-btn",
            ...
            exactMatch: false,
            localeCompare: false,
            searchInput: '.ea-ec-search-wrap',
            paginationElement: '.eael-event-calendar-pagination',
            onInit: function () {
            },
        ...
        this.tableUpdate = function (elm) {
            ...
            if (settings.pagination) {
                var paginationElement = settings.paginationElement;
                paginationElement.empty();
                if (elm.fancyTable.pages > 1) {
        ...
        this.each(function () {
            ...
            if (settings.pagination && !settings.paginationElement) {
                settings.paginationElement.html('');
            }
            instance.tableUpdate(elm);
