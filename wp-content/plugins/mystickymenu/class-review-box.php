...
class myStickyMenu_Pro_review_box
{
	 ...
	 * @access public
	 */
	public $pluginName = "My Sticky Bar";
	 ...
	 * @access public
	 */
	public $pluginSlug = "my-sticky-menu";
	 ...
	 * @access public
	 */
	public $wpPluginSlug = "mystickymenu";
        ...
        <div class="notice notice-info premio-notice <?php echo esc_attr($this->pluginSlug) ?>-premio-review-box">
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default">
                <h2 class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__title">
					<?php esc_html_e('Your', 'mystickymenu') ?> <span><?php esc_html_e('feedback', 'mystickymenu') ?></span> <?php esc_html_e('matters, please leave a review', 'mystickymenu') ?> 🙏
                </h2>
                ...
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder">
                    <span>
                        <b><?php esc_html_e('Gal Dubinski', 'mystickymenu') ?></b>,
                        <?php esc_html_e('Co-founder', 'mystickymenu') ?>
                    </span>
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder-img" width="30" height="30" src="<?php echo esc_url(MYSTICKYMENU_URL."images/premio-owner.png") ?>" />
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you">
                <div class="thanks-wrap">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__image" width="200" src="<?php echo esc_url(MYSTICKYMENU_URL."images/thanks.gif") ?>" />

                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__message">
                        <div class="title"><?php esc_html_e("You are awesome ", 'mystickymenu')?> &#128591;</div>
                        <div class="desc"><?php esc_html_e("Thanks for your support, we really appreciate it!", 'mystickymenu')?></div>
                        <div class="footer"><?php esc_html_e("Premio team ", 'mystickymenu')?></div>
                    </div>
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup">
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__content">
                    ...
                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__title">
						<?php esc_html_e("Would you like us to remind you about this later?", 'mystickymenu')?>
                    </div>

                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__options">
                        <a href="#" data-days="3"><?php esc_html_e("Remind me in 3 days ", 'mystickymenu')?></a>
                        <a href="#" data-days="10"><?php esc_html_e("Remind me in 10 days ", 'mystickymenu')?></a>
...
//$myStickyMenu_Pro_review_box = new myStickyMenu_Pro_review_box();
